...
FILESEXTRAPATHS_prepend := "${THISDIR}/bind-native:"

DEPENDS = "openssl-native libcap zlib"

SRC_URI = "https://ftp.isc.org/isc/bind9/${PV}/bind-${PV}.tar.gz \
           file://conf.patch \
           file://named.service \
           file://bind9 \
...
do_install_append() {
	...
	#workaround: install header files manually
	install -d 0755 ${D}${includedir}/bind
	install -m 0644 ${STAGING_DIR_HOST}/usr/include/*.h ${D}${includedir}/bind
}
